...
_C.loss.fine_hidden = 0
_C.loss.cosine_classifier = False
_C.loss.cosine_scale = 16.0
_C.loss.scheduled_sampling = False
_C.loss.aux100_weight = 0.0
_C.loss.coarse_conf_weight = False
_C.loss.fine_label_smooth = 0.0
_C.loss.use_film = False
_C.loss.etf_coarse = False
_C.loss.etf_fine = False
...
_C.train.nc_dynamics_interval = 0
...
_C.transforms = CN()
_C.transforms.train_transforms = (
    "random_resized_crop", "random_horizontal_flip")
_C.transforms.test_transforms = (
